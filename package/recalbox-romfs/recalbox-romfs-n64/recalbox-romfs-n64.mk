...
# ./scripts/linux/empack.py --system n64 --extension '.n64 .N64 .v64 .V64 .z64 .Z64 .bin .BIN .u1 .U1 .ndd .NDD .zip .ZIP .7z .7Z' --fullname 'Nintendo 64' --platform n64 --theme n64 mupen64plus:gliden64:BR2_PACKAGE_MUPEN64PLUS_GLIDEN64 mupen64plus:n64:BR2_PACKAGE_MUPEN64PLUS_GLES2N64 mupen64plus:rice:BR2_PACKAGE_MUPEN64PLUS_GLES2RICE mupen64plus:glide64mk2:BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLIDE64MK2 libretro:mupen64plus:BR2_PACKAGE_LIBRETRO_MUPEN64PLUS libretro:mupen64plus_next:BR2_PACKAGE_LIBRETRO_MUPEN64PLUS_NX
...
define CONFIGURE_MAIN_N64_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_N64),Nintendo 64,$(SYSTEM_NAME_N64),.n64 .N64 .v64 .V64 .z64 .Z64 .bin .BIN .u1 .U1 .ndd .NDD .zip .ZIP .7z .7Z,n64,n64)
endef
