...
nano vim automake autopoint mtools dosfstools subversion openjdk-8-jdk libssl1.0-dev libelf-dev \
graphviz python-matplotlib python-numpy python-six re2c libc6-dev-i386 libtool curl 
